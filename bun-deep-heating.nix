...
}:
{
  ...
  "knip@5.73.2" = fetchurl {
    url = "https://registry.npmjs.org/knip/-/knip-5.73.2.tgz";
    hash = "sha512-fGSxQhWGA0CMzwcgvy4kkYdVtbyRzGS9vX9/cScVunELAs4HpfBLfVcLLPIZIthgp/YB8DnjfZMAAOC77vE/Ug==";
  };
