...
- [#1112](https://github.com/GraemeF/home-automation/pull/1112) [`d7e0cca`](https://github.com/GraemeF/home-automation/commit/d7e0cca9c9d0bc6009a926382d43b4cbb4082d12) Thanks [@GraemeF](https://github.com/GraemeF)! - Improve error messages for Home Assistant API operations. Connection failures, temperature changes, and HVAC mode changes now report specific error types with detailed context for easier troubleshooting.
